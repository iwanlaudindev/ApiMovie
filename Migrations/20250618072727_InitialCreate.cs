    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentHobbies", x => new { x.HobbiesId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_StudentHobbies_Hobbies_HobbiesId",
                        column: x => x.HobbiesId,
                        principalTable: "Hobbies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentHobbies_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentHobbies_StudentsId",
